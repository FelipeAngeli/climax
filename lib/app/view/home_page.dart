...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    bloc.add(FetchWeatherEvent("curitiba"));
  }

  @override
  Widget build(BuildContext context) {
    var blocBuilder = BlocBuilder<HomeBloc, ProductState>(
        bloc: bloc,
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child:
                        Image.asset("assets/icons/calendario.png", width: 20),
                  ),
                  Text("Descrição " + state.weather.description),
                ],
              ),
              Row(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(5.0),
                    child:
                        Image.asset("assets/icons/temperatura.png", width: 20),
                  ),
                  Text("Temperatura " + state.weather.temperature),
                ],
              ),
              Row(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(5.0),
                    child: Image.asset("assets/icons/wind.png", width: 20),
                  ),
                  Text("Vento " + state.weather.wind),
                ],
              ),
            ],
          ));
